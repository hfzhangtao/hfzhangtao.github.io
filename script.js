...
document.querySelectorAll('.pub-filter-btn').forEach(function(btn) {
  btn.addEventListener('click', function() {
    ...
    // Hide/show the "Show All" toggle during filtering
    if (filter !== 'all') {
      // When filtering, show all matching items including hidden ones,
...
// Puzzle modal toggle
var puzzleModal = document.getElementById('puzzleModal');
var puzzleTrigger = document.getElementById('puzzleTrigger');
var puzzleClose = document.getElementById('puzzleModalClose');

puzzleTrigger?.addEventListener('click', function() {
  if (puzzleModal) {
...
document.addEventListener('keydown', function(e) {
  if (e.key === 'Escape' && puzzleModal && !puzzleModal.classList.contains('hidden')) {
    closePuzzleModal();
  }
});
